    ...
    <form method="POST" action="{{ route('suppliers.update',['id' => $suppliers->id]) }}">
      ...
      @csrf
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="inic" placeholder="Supplier INIC" name="inic" value="{{ $suppliers->inic }}">
                </div>
                <div class="form-group">
                ...
                <div class="input-group">
                  ...
                  <input type="text" class="form-control" placeholder="Contact Number" data-inputmask="'mask': ['999-999-9999 [x99999]', '+092 99 99 9999[9]-9999']" data-mask="" id="phone_number" name="phone_number" value="{{ $suppliers->phone_number }}">
                </div>
                </div>
                <div class="form-group">
                ...
                <select class="form-control" id="sup_material" name="material" name="material">
                  ...
                  <input type="text" class="form-control" id="price" placeholder="Material Price(per single entity)" name="price" value="{{ $suppliers->price }}">
                </div>
