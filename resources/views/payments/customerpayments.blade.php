        ...
        <div class="box box-body" style=" background-color: #f4f4f487; padding: 0px;">
            <div class="box-header">
                ...
                <div class="box-tools pull-right">
                    <a type="links" href="{{ route('customerpayment.create') }}" class="btn btn-primary pul-right">Add
                        new Payment</a>
                </div>
...
{{--                                            <td>{{ $payment->budget }}</td>--}}
                                            <td style="max-width: 50px;">
                                                ...
                                                <div class="btn-group">
                                                    ...
                                                    <div class="btn-group">
                                                        <button data-toggle="dropdown" class="btn btn-success btn-sm"
                                                                type="button">Action<span
                                                                    class="glyphicon glyphicon-triangle-bottom"></span>
                                                        </button>
                                                        <ul role="menu" class="dropdown-menu">
                                                            <li><a type="links" data-toggle="modal"
                                                                   data-target="#EditModal-{{ $payment->id }}"><i
                                                                            class="fa fa-edit"></i>Edit</a></li>

                                                            {{-- <li><a href="{{ route('users.edit', ['id' => $user->id]) }}"><i class="fa fa-edit"></i>Edit</a></li> --}}

                                                            <li><a type="links" data-toggle="modal"
                                                                   data-target="#applicantDeleteModal-{{ $payment->id }}"><i
...
--}}
                                        ...
                                        <div id="applicantDeleteModal-{{ $payment->id }}" class="modal fade"
                                             tabindex="-1" role="dialog"
