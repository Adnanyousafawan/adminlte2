                            ...
                            <table id="example2" class="table table-bordered table-hover dataTable" role="grid"
                                ...
                                <tr role="row">
                                    ...
                                    <th width="10%" class="sorting_asc" tabindex="0" aria-controls="example2"
                                        ...
                                        aria-sort="ascending">Employee Name
                                    </th>
                                    ...
                                    <th width="8%" class="sorting hidden-xs" tabindex="0" aria-controls="example2"
                                        rowspan="1" colspan="1"
                                        aria-label="Birthdate: activate to sort column ascending">Birthdate
                                    </th>
                                    <th width="8%" class="sorting hidden-xs" tabindex="0" aria-controls="example2"
                                        rowspan="1" colspan="1"
                                        aria-label="HiredDate: activate to sort column ascending">Hired Date
                                    </th>
                                    <th width="8%" class="sorting hidden-xs" tabindex="0" aria-controls="example2"
                                        rowspan="1" colspan="1"
                                    ...
                                    <th width="8%" class="sorting hidden-xs" tabindex="0" aria-controls="example2"
                                        rowspan="1" colspan="1"
                                        aria-label="Division: activate to sort column ascending">Division
                                    </th>
                                ...
                                {{--   @foreach ($employees as $employee)
                                      <tr role="row" class="odd">
                                        ...
                                        <td>
                                          <form class="row" method="POST" action="{{ route('employee-management.add_labor', ['id' => $employee->id]) }}" onsubmit = "return confirm('Are you sure?')">
                                              <input type="hidden" name="_method" value="DELETE">
                                              <input type="hidden" name="_token" value="{{ csrf_token() }}">
                                              <a href="{{ route('employee-management.add_labor', ['id' => $employee->id]) }}" class="btn btn-warning col-sm-3 col-xs-5 btn-margin">
                                              Update
                                              </a>
