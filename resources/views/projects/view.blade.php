	...
	<strong><i class="fa fa-book"></i>Project Details</strong>
               <div class="box-body">
                ...
                <li class="list-group-item">
                  <b>Size</b> <a class="pull-right"> <span class="label label-danger">500 sq/m</span></a>
                </li>
                <li class="list-group-item">
                    ...
                    <div class="table-responsive">
                        <table class="table no-margin">
                            ...
                            <tr>
                                ...
                                <td>12</td>
                                <td>12*3=24</td>
                                <td><span class="label label-info col-md-6 col-sm-10 col-xs-12 col-lg-12"> Processing</span></td>
                            ...
                            <tr>
                                ...
                                <td>12</td>
                                <td>12*3=24</td>
                                <td><span class="label label-success col-md-6 col-sm-10 col-xs-12 col-lg-12 col-12">Shipped</span></td>
