        ...
        <div class="row" style="margin-top: 30px;">
            <div class="form-group col-md-3">
                ...
                <div class="input-group col-md-10 col-xs-10 col-xs-offset-1">
                    ...
                    <hr>
                    <img class="img-fluid img-responsive col-md-10 col-xs-10"
                         style="min-width: 100%; min-height: 200px; margin-bottom: 10px;">
                    <hr>
                    <div class="form-group">
                        <input type="file" class="btn btn-primary col-md-10 col-md-offset-1 col-xs-10 col-xs-offset-1"
                               id="contract_image"
                               name="contract_image">
                    </div>
                </div>
                    ...
                    <div class="input-group col-md-10 col-md-offset-2">
                        ...
                        <div class="input-group">
                            ...
                            <input type="number" maxlength="14" class="form-control"
                                   data-inputmask="&quot;mask&quot;: &quot;(999) 999-9999&quot;" data-mask="" id="phone"
                                   name="phone" required>
