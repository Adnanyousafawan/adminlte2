                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-3">
                                    <input type="search" name="search_customer" id="search_customer"
                                           placeholder="Search By Customer" class="form-control">
                                </div>
                            ...
                            <table id="example2" class="table table-bordered table-hover dataTable" role="grid"
                                ...
                                <tr role="row">
                                    <th width="10%" class="sorting hidden-xs" tabindex="0" aria-controls="example2"
                                        ...
                                        aria-sort="ascending">Title
                                    </th>
                                    <th width="8%" class="sorting_asc" tabindex="0" aria-controls="example2" rowspan="1"
                                        colspan="1" aria-label="Email: activate to sort column ascending">Owner Name
                                    </th>
                                ...
                                @foreach ($projects as $project)
                                    <tr role="row" class="odd">
                                        ...
                                        <td class="hidden-xs">{{ $contractors[$project->assigned_to -1]->cont_name }}</td>
                    ...
                    <div class="row">
                        <div class="col-sm-5">
                            <div class="dataTables_info" id="example2_info" role="status" aria-live="polite">Showing 1
                                to {{count($projects)}} of {{count($projects)}} entries
                            </div>
                        </div>
                        <div class="col-sm-7">
