...
<div class="box-body">
		...
		<div class="col-lg-8 col-lg-offset-2">
                  ...
                  <input type="text" class="form-control" id="proj_title" placeholder="Project Title">
                </div>

                <div class="form-group">
                  <label for="proj_location">Project Location</label>
                  <input type="text" class="form-control" id="proj_location
                  " placeholder="Project Location">
                </div>
                <div class="form-group">
                  <label for="proj_area">Project Area</label>
                  <input type="text" class="form-control" id="proj_area" placeholder="Project Area">
                </div>
                <div class="form-group">
                  <label for="proj_city">Project City</label>
                  <input type="text" class="form-control" id="proj_city" placeholder="Project City">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="cus_cnic" placeholder="Customer CNIC">
                </div>
                <div class="form-group">
                  <label for="cus_contact">Customer Contact</label>
                  <input type="text" class="form-control" id="cust_contact" placeholder="Customer Contact">
                </div>
                <div class="form-group">
            ...
            <div class="form-group">
               <div class="row">
                ...
                <div class="col-xs-5">
                  <input type="text" class="form-control" placeholder="Estimated Cost(in Rupees)">
                </div>
               </div>
              </div>
              <div class="form-group">
            ...
            <button type="button" class="btn btn-block btn-primary btn-xs form-control">Add Project</button>
        </div>
    </div>
</div>
