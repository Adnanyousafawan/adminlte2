		...
		<div class="col-md-3">
          ...
          <div class="box box-primary">
            <div class="box-body box-profile">
             <img class="profile-user-img img-responsive img-circle" src="../../dist/img/user4-128x128.jpg" alt="Contractor Image">
 ...
 <div class="col-md-6 col-sm-4 ">
            <div class="box box-info" style="max-width: 96%; margin-left: 2%;">
                ...
                <div class="box-footer clearfix">
                    ...
                    <a href="javascript:void(0)" class="btn btn-sm btn-default btn-flat pull-right">View All Projects</a><div class="row">
                    <div class="col-sm-5">
