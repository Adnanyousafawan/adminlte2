  ...
  <form method="post" action="{{ route('contractors.store') }}">
	<div class="col-lg-8 col-lg-offset-2">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="cont_name" placeholder="Contractor Name" name="cont_name">
                </div>
                <div class="form-group">
                  <label for="cont_cnic">Contractor CNIC</label>
                  <input type="text" class="form-control" id="cont_cnic" placeholder="Contractor CNIC" name="cont_cnic">
                </div>
                <div class="form-group">
                ...
                <div class="input-group">
                  ...
                  <input type="text" class="form-control" placeholder="Contact Number" data-inputmask="'mask': ['999-999-9999 [x99999]', '+092 99 99 9999[9]-9999']" data-mask="" id="cont_contact" name="cont_contact">
                </div>
                </div>
                <div class="form-group">
                  <label for="cont_address">Home Address</label>
                  <input type="text" class="form-control" id="cont_address" name="cont_address" placeholder="Home Address">
                </div>
                <div class="form-group">
                ...
                <select class="form-control" id="cont_past_projects" name="cont_past_projects" >
