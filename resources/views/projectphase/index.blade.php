      ...
      <div class="col-md-8 col-xl-8 col-lg-8 col-sm-10 col-xs-12 col-md-offset-2 col-xl-offset-2 col-lg-offset-2 col-sm-offset-1 col-xs-offset-0 " style="margin-bottom: 70px;">
                    ...
                    <div class="box box-primary" style="margin-bottom: 10px;">
                        <div class="box-header with-border">
                            <h3 class="box-title">Project Phases</h3>

                            <div class="box-tools pull-right">
                                <a href="{{ route('phases.create')}}" class="btn btn-sm btn-primary btn-flat pull-left">Add Project Phase</a>
                            </div>
                        </div>
                        <!-- /.box-header -->
                        <div class="box-body">
                                        ...
                                        <td style="max-width: 50px;">
                                            ...
                                            <div class="btn-group">
                                              ...
                                              <ul role="menu" class="dropdown-menu">
                                                  <li><a href="{{ route('phases.edit', ['id' => $phase->id]) }}"><i class="fa fa-edit"></i>Edit</a></li>
                                                  <li><a type="links" data-toggle="modal" data-target="#applicantDeleteModal-{{ $phase->id }}"><i class="fa fa-remove"></i>Delete</a></li>
                                              </ul>
                                          </div>
                                      </td>
                                  </tr>
...
{{-- ______________________________Delete Modal ______________________________________________--}}
                                ...
                                <div id="applicantDeleteModal-{{ $phase->id }}" class="modal fade" tabindex="-1" role="dialog"
                                    ...
                                    <div class="modal-dialog"
                                        ...
                                        <div class="modal-content">
                                            <form class="row" method="POST"
                                                  action="{{ route('phases.destroy', ['id' => $phase->id]) }}">
                                                <input type="hidden" name="_method" value="DELETE">
                                                <input type="hidden" name="_token" value="{{ csrf_token() }}">
                                                <form action="{{ route('phases.destroy', ['id' => $phase->id]) }}"
