            ...
            <div class="box box-body" style=" background-color: #f4f4f487; padding: 0px;">
                <div class="box-header">
                    ...
                    <div class="box-tools pull-right">
                        <a type="links" href="{{ route('order.create') }}" class="btn btn-primary pul-right">Place
                            Order</a>
                    </div>
                    <div class="vendor-list-status">
                        ...
                        <div
                            ...
                            @can('isAdmin')
                            <div class="container">
                                <a class="active" href=" {{ route('orders.list') }}" style="font-size: 20px;">Approved
                                    &nbsp; | &nbsp; </a>
                                <a class="active" href=" {{ route('orders.recieved') }}" style="font-size: 20px;">Rejected
                                    &nbsp; | &nbsp;</a>
                                ...
                                <div class="table-responsive" style="margin-top: 10px; padding: 10px;">
                                    <table class="table no-margin table-bordered table-striped project">
                                        ...
                                        @foreach ($materialrequests as $materialrequest)
                                            <tr>
                                                <td>OR0000{{ $materialrequest->id }}</td>
