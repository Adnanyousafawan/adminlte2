  ...
  <form method="post" action="{{ route('managers.store') }}">
	<div class="col-lg-8 col-lg-offset-2">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="man_name" name="man_name" placeholder="Manager Name">
                </div>
                <div class="form-group">
                  <label for="man_cnic">Manager CNIC</label>
                  <input type="text" class="form-control" id="man_cnic" name="man_cnic" placeholder="Manager CNIC">
                </div>
                <div class="form-group">
                ...
                <div class="input-group">
                  ...
                  <input type="text" class="form-control" placeholder="Contact Number" data-inputmask="'mask': ['999-999-9999 [x99999]', '+092 99 99 9999[9]-9999']" data-mask="" id="man_contact" name="man_contact">
                </div>
                </div>
                <div class="form-group">
                  <label for="man_address">Address</label>
                  <input type="text" class="form-control" id="man_address" name="man_address" placeholder="Home Address">
                </div>
                <div class="form-group">
