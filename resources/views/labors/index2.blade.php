...
{{-- col-md-11 col-md-offset-1 col-sm-11 col-sm-offset-1 col-lg-11 col-lg-offset-1
 --}}
 <div class="box-body " style="max-width: 94%; margin-left: 3%; margin-top: 3%; padding: 0px; background-color: #f4f4f487;" >
...
<div class="row" style="margin-top: 30px;">
 <div class="col-md-6 col-sm-6 col-lg-6 col-md-offset-1 col-lg-offset-1">
        ...
        <div class="col-md-2 col-sm-6 col-lg-4">
           <div class="box box-primary border-primary">
            <div class="box-header">
              <h2 class="box-title">Free Labor</h2>
               <span class="info-box-number" style="margin-top: 5px;">102000/RS.</span>
            </div>
            <!-- /.box-header -->
                   <!-- <span class="info-box-number" style=" float: right;">102000/RS.</span> -->
        ...
        <button type="button" class="btn btn-tool col-md-2 col-md-offset-8 "  style="float: right; margin-right: 15px; margin-top: 10px;" data-target="#search_area"  data-toggle="collapse">
            <i>Search Labor</i>
        </button>

    <div id="search_area" class="collapse col-md-10 col-sm-10 col-lg-10 col-md-offset-1 col-sm-offset-1 col-lg-offset-1" style="padding: 30px; background-color: rgb(53, 124, 165);">
 ...
 <div class="col-md-10 col-sm-10 col-lg-10 col-md-offset-1 col-lg-offset-1 col-sm-offset-1 ">
            <div class="box box-primary" style="margin-bottom: 10px; margin-top: 10px;">
                        ...
                        <table class="table no-margin">
                            ...
                            <tr>
                                        ...
                                        <td style="max-width: 30px;">
                                            ...
                                            Edit</a>
                                            <button type="button" class="btn-link" data-toggle="modal" data-target="#applicantDeleteModal"style="margin-left: 3px;  margin-top: 0px;">
                                             Delete
                                            </button>
                ...
                <div class="box-footer clearfix">
                    ...
                    {{-- <a href="javascript:void(0)" class="btn btn-sm btn-default btn-flat pull-right">View All Orders</a><div class="row">
                    <div class="col-sm-5"> --}}
                        <div class="dataTables_info" id="example2_info" role="status" aria-live="polite">Showing 1
