            ...
            <div class="row" style="padding: 20px;">
                ...
                <!-- /.box-header -->
                    <div class="box-body" style=" padding-bottom: 0px;">
                        <button type="button"
                                class="btn btn-primary col-xs-8 col-xs-offset-2 col-sm-8 col-md-8 col-lg-8 col-sm-offset-2  col-lg-offset-2 col-md-offset-2 "
                                data-target="#search_area" data-toggle="collapse">
                            <i>Search Labor</i>
                        </button>
                    ...
                    <div id="search_area"
                         class="collapse col-md-8 col-lg-8 col-lg-offset-2 col-md-offset-2 col-sm-8 col-sm-offset-2"
                         style="padding: 30px; background-color: rgb(53, 124, 165);">
                        ...
                        <div class="box box-primary" style="margin-bottom: 10px; margin-top: 1%;">
                            ...
                            <div class="box-header with-border ">
                                ...
                                <div class="box-tools pull-right">
                                    ...
                                    <a href="{{ route('labors.create') }}" class="btn btn-primary pul-right">Add
                                        Labor</a>
                                    ...
                                    <table class="table no-margin">
                                        ...
                                        @foreach ($labors as $labor)
                                            <tr>
                                                ...
                                                <td>{{ $labor->rate }}</td>
                                                <td>25000</td>
                                                <td style="max-width: 50px; min-width: 30px">
                                                    <a type="links"
                                                       href="{{ route('labors.edit', ['id' => $labor->id]) }}"
                                                       class="btn-link"
                                                       style="margin-left: 3px; margin-top: 0px; color: #f0ad4e;">
                                                        Edit</a>
                                                    <button type="button" class="btn-link" data-toggle="modal"
                                                            data-target="#applicantDeleteModal"
                                                            style="color: red; margin-left: 3px;  margin-top: 0px;">
                                                        Delete
                                                    </button>
                                        ...
                                        <div id="applicantDeleteModal" class="modal fade" tabindex="-1" role="dialog"
                                            ...
                                            <div class="modal-dialog"
                                                 style="min-width:50%; align-content: center; text-align: center;">
                                                    ...
                                                    <form class="row" method="POST"
                                                        ...
                                                        <div class="modal-header">
                                                            ...
                                                            <h4 class="modal-title text-center"
                                                                id="custom-width-modalLabel">Delete Applicant
                                                                Record</h4>
                                                        </div>
                                                        <div class="modal-body">
                                                            <strong><b><h2>Are You Sure? You Want Delete This
                                                                        Record?</h2></b></strong>
